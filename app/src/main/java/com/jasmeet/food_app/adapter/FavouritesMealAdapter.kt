...
import com.jasmeet.food_app.databinding.FavItemsBinding
import com.jasmeet.food_app.pojo.Meal

class FavouritesMealAdapter:RecyclerView.Adapter<FavouritesMealAdapter.FavouritesMealsViewHolder>() {

    class FavouritesMealsViewHolder(val binding: FavItemsBinding): RecyclerView.ViewHolder(binding.root)
