...
import com.jasmeet.food_app.databinding.MealItemBinding
...
class CategoryMealsAdapter():RecyclerView.Adapter<CategoryMealsAdapter.CategoryMealsViewModel>() {
    ...
    fun setMealsList(mealsList: List<MealsByCategory>){
        this.mealsList = mealsList as ArrayList<MealsByCategory> /* = java.util.ArrayList<com.jasmeet.food_app.pojo.MealsByCategory> */
